...
for index,file in enumerate(filelist):
    ...
    total_energy_of_speech=total_energy_of_speech+energy_of_speech
    total_energy_nonspeech=total_energy_nonspeech+energy_of_nonspeech

total_energy_nonspeech=total_energy_nonspeech/1000
total_energy_of_speech=total_energy_of_speech/1000
print(total_energy_of_speech)
print(total_energy_nonspeech)
